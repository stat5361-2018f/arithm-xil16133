...
## R codes of conducting experiments
```{r}
n <- c(100, 1000, 10000)
...
The following two tables including the results averaged from 100 repetations for each situation. By comparing the results of the 2, 3 and 4 row with the 1st row, we can find that larger the sample size, smaller the difference between the approximated probability and the true probability.
